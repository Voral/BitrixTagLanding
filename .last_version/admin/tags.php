...
$POST_RIGHT = CMain::GetGroupRight("vasoft.tags");
...
?>
    <form name="find_form" method="get" action="<?= $APPLICATION->GetCurPage() ?>">
        ...
        <tr>
            ...
            <td><input type="text" name="find_phrase" size="47" value="<?= htmlspecialchars($find_phrase) ?>"></td>
        </tr>
        <tr>
            <td><b><?= Loc::getMessage('VASOFT_TAGS_FIELD_CODE') ?>:</b></td>
            <td><input type="text" name="find_code" size="47" value="<?= htmlspecialchars($find_code) ?>"></td>
        </tr>
        <tr>
            <td><b><?= Loc::getMessage('VASOFT_TAGS_FIELD_TITLE') ?>:</b></td>
            <td><input type="text" name="find_title" size="47" value="<?= htmlspecialchars($find_title) ?>"></td>
        </tr>
        <tr>
